...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _common_forms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/forms */ \"./src/js/common/forms.js\");\n/* harmony import */ var _common_forms__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_forms__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _common_global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/global */ \"./src/js/common/global.js\");\n/* harmony import */ var _register__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register */ \"./src/js/pages/register.js\");\n\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  'use strict';\n\n  closeMemoryTip();\n  (0,_common_global__WEBPACK_IMPORTED_MODULE_1__.submitAuthForm)('#form-login', 'ih_ajax_login');\n  (0,_register__WEBPACK_IMPORTED_MODULE_2__.checkFormStatus)(document.querySelector('#form-login'));\n});\nvar closeMemoryTip = function closeMemoryTip() {\n  var tip = document.querySelector('.memory-tip');\n  if (!tip) return;\n  tip.addEventListener('click', function () {\n    return tip.remove();\n  });\n};\n\n//# sourceURL=webpack://inheart/./src/js/pages/login.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   checkFormStatus: function() { return /* binding */ checkFormStatus; }\n/* harmony export */ });\n/* harmony import */ var _common_forms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/forms */ \"./src/js/common/forms.js\");\n/* harmony import */ var _common_forms__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_forms__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _common_global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/global */ \"./src/js/common/global.js\");\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  'use strict';\n\n  checkFormStatus(document.querySelector('#form-register'));\n  (0,_common_global__WEBPACK_IMPORTED_MODULE_1__.submitAuthForm)('#form-register', 'ih_ajax_register');\n});\nvar checkFormStatus = function checkFormStatus(form) {\n  if (!form) return;\n  var fields = form.querySelectorAll('input:not([type=\"hidden\"])');\n  if (!fields.length) return;\n  var submitButton = form.querySelector('button[type=\"submit\"]');\n  var onInputChange = function onInputChange() {\n    var isFormFilled = true;\n    fields.forEach(function (field) {\n      var value = field.type === 'checkbox' ? field.checked : field.value;\n      if (!value) isFormFilled = false;\n    });\n    if (isFormFilled) submitButton.removeAttribute('disabled');else submitButton.setAttribute('disabled', 'disabled');\n  };\n  fields.forEach(function (field) {\n    return field.addEventListener('change', onInputChange);\n  });\n  fields.forEach(function (field) {\n    return field.addEventListener('keyup', onInputChange);\n  });\n};\n\n//# sourceURL=webpack://inheart/./src/js/pages/register.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/pages/login.js");
/******/ 	
/******/ })()
;