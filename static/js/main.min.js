...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! body-scroll-lock */ \"./node_modules/body-scroll-lock/lib/bodyScrollLock.esm.js\");\n/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global */ \"./src/js/common/global.js\");\n/* harmony import */ var _new_memory_step_1__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../new-memory/step-1 */ \"./src/js/new-memory/step-1.js\");\n\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  'use strict';\n\n  toggleMenu();\n  toggleProfileMenu();\n  (0,_new_memory_step_1__WEBPACK_IMPORTED_MODULE_2__.initDatepickers)();\n});\nvar toggleMenu = function toggleMenu() {\n  var menuButton = document.querySelector('.header-menu-button'),\n    menuWrap = document.querySelector('#header-nav-wrap'),\n    header = menuButton ? menuButton.closest('header') : null;\n  if (!header || !menuButton || !menuWrap) return;\n  menuButton.addEventListener('click', function () {\n    (0,_global__WEBPACK_IMPORTED_MODULE_1__.setTargetElement)('#header-nav-wrap');\n    if (!header.classList.contains('menu-opened')) {\n      window.scrollTo(0, 0);\n      header.classList.add('menu-visible', 'menu-opened');\n      (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.disableBodyScroll)((0,_global__WEBPACK_IMPORTED_MODULE_1__.getTargetElement)(), {\n        reserveScrollBarGap: true\n      });\n    } else {\n      header.classList.remove('menu-opened');\n      setTimeout(function () {\n        header.classList.remove('menu-visible');\n        (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.enableBodyScroll)((0,_global__WEBPACK_IMPORTED_MODULE_1__.getTargetElement)());\n      }, 350);\n    }\n  });\n};\n\n/**\r\n * Show/hide header profile dropdown menu.\r\n */\nvar toggleProfileMenu = function toggleProfileMenu() {\n  var button = document.querySelector('.header-profile-button'),\n    wrapper = document.querySelector('.header-profile'),\n    dropdown = document.querySelector('.header-profile-dropdown');\n  if (!button || !wrapper || !dropdown) return;\n  button.addEventListener('click', function () {\n    if (wrapper.classList.contains('opened')) wrapper.classList.remove('opened');else wrapper.classList.add('opened');\n  });\n\n  // Close header profile dropdown on click outside.\n  document.addEventListener('click', function (e) {\n    var target = e.target;\n    if (wrapper.classList.contains('opened') && !target.closest('.header-profile')) wrapper.classList.remove('opened');\n  });\n};\n\n//# sourceURL=webpack://inheart/./src/js/common/common.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _common_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common/common */ \"./src/js/common/common.js\");\n/* harmony import */ var _auth_ajax__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth/ajax */ \"./src/js/auth/ajax.js\");\n\n\n\n//# sourceURL=webpack://inheart/./src/js/main.js?");
