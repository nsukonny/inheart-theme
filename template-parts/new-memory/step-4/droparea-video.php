...
<div class="droparea droparea-video flex align-end justify-center">
	...
	<div class="droparea-videos flex flex-wrap hidden">
		<div class="droparea-videos-load flex direction-column align-center justify-end">
			<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
				<mask id="mask0_2655_452" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="20">
