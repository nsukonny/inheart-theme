 ...
 * Step 2. Section original content.
 *
...
<div class="section-content original hidden" data-id="<?php echo esc_attr( $index ) ?>">
	...
	<div class="section-content-photos flex flex-wrap"></div>
