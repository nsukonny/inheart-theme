...
>
	<div class="container direction-column align-center">
		<h2 class="military-created-title flex justify-center align-center">
			<?php
			if( $is_edit ) _e( "Сторінка пам’яті оновлена", 'inheart' );
			else _e( "Сторінка пам’яті створена", 'inheart' );
			?>
		</h2>

		<p class="military-created-desc">
			<?php _e( 'Поділіться історією життя з близькими в Instagram', 'inheart' ) ?>
		</p>
						...
						<div class="military-created-date military-created-date-born flex direction-column align-center">
							...
							<div class="military-created-date-inner flex align-center">
								<div class="military-created-date-left flex direction-column align-center">
									...
									<span class="military-created-date-month"></span>
								</div>
		...
		<div class="military-created-qr flex justify-center">
			<a href="/" class="button outlined lg button-icon-lead">
				<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M10.6667 11.8333V11.1667H8.66667V9.16667H10.6667V10.5H12V11.8333H11.3333V13.1667H10V14.5H8.66667V12.5H10V11.8333H10.6667ZM14 14.5H11.3333V13.1667H12.6667V11.8333H14V14.5ZM2 2.5H7.33333V7.83333H2V2.5ZM3.33333 3.83333V6.5H6V3.83333H3.33333ZM8.66667 2.5H14V7.83333H8.66667V2.5ZM10 3.83333V6.5H12.6667V3.83333H10ZM2 9.16667H7.33333V14.5H2V9.16667ZM3.33333 10.5V13.1667H6V10.5H3.33333ZM12 9.16667H14V10.5H12V9.16667ZM4 4.5H5.33333V5.83333H4V4.5ZM4 11.1667H5.33333V12.5H4V11.1667ZM10.6667 4.5H12V5.83333H10.6667V4.5Z" fill="#08091C"/>
				</svg>
				<span class="button-text">
					<?php _e( 'Замовити qr-код', 'inheart' ) ?>
				</span>
			</a>
		</div>
	</div>
