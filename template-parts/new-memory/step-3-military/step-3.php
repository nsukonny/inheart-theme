	...
	<div class="container direction-column">
		...
		if( $title ){
			...
			<div class="new-memory-step-title flex align-center">
				...
				<button class="button tetriary sm button-icon-lead button-icon-tail">
					...
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M7.33203 7.33325V3.99992C7.33203 3.63173 7.63051 3.33325 7.9987 3.33325V3.33325C8.36689 3.33325 8.66536 3.63173 8.66536 3.99992V7.33325H11.9987C12.3669 7.33325 12.6654 7.63173 12.6654 7.99992V7.99992C12.6654 8.36811 12.3669 8.66659 11.9987 8.66659H8.66536V11.9999C8.66536 12.3681 8.36689 12.6666 7.9987 12.6666V12.6666C7.63051 12.6666 7.33203 12.3681 7.33203 11.9999V8.66659H3.9987C3.63051 8.66659 3.33203 8.36811 3.33203 7.99992V7.99992C3.33203 7.63173 3.63051 7.33325 3.9987 7.33325H7.33203Z" fill="#F7B941"/>
					</svg>
				</button>
			</div>
			<?php
		...
		<div class="no-rewards-body flex direction-column align-center justify-center">
			<?php
			if( $no_rewards_img )
