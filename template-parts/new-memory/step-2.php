	...
	<div class="container">
		...
		if( $sections ){
			...
			<div class="new-memory-main-info sections-wrapper flex flex-wrap">
				<div class="sections-sidebar">
					<div class="sections-added">
						...
						<div class="sections-added-list flex direction-column">
							<div class="section flex flex-wrap align-center" style="order: 0">
					...
					<div class="sections">
						...
						<div class="sections-list flex direction-column">
							...
							foreach( $sections as $key => $section ){
								...
								?>
								<div class="section flex flex-wrap align-center" style="order: <?php echo esc_attr( $key ) ?>">
									<div class="section-label">
				...
				<div class="sections-content">Content</div>
