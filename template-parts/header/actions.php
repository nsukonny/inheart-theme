...
<div class="header-actions flex align-center justify-end hide-before-md">
	<a href="<?php echo get_the_permalink( pll_get_post( ih_get_login_page_id() ) ) ?>" class="header-sign-in flex align-center" aria-label="<?php esc_attr_e( 'Увійти', 'inheart' ) ?>">
	...
	<a href="<?php echo get_the_permalink( pll_get_post( ih_get_memory_creation_page_id() ) ) ?>" class="btn lg primary" aria-label="<?php esc_attr_e( "Створити сторінку пам'яті", 'inheart' ) ?>">
