...
<div class="reward-preview full custom flex direction-column align-center" data-id="<?php echo esc_attr( $id ) ?>">
	<div class="reward-preview-thumb">
		<img src="<?php echo THEME_URI ?>/static/img/no-rewards-min.png" alt="" />
	</div>

	<div class="reward-preview-title"><?php echo esc_html( $reward['reward_custom_name'] ) ?></div>
